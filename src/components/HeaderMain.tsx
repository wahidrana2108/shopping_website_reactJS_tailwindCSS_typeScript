    ...
    <div className='border-b border-gray-200 py-6'>
        <div className="container sm:flex justify-between items-center">
            ...
            <div className="w-full sm:w-[300px] md:w-[70%] relative">
                <input type="text" placeholder='Enter any product name...' className='border-gray-200 border p-2 px-4 rounded-lg w-full' size={20}/>
                <BsSearch className='absolute right-0 top-0 mt-3 mr-3 text-gray-400'/>
            </div>
